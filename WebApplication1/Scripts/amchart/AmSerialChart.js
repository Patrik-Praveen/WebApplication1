            ...
            if (_this.realWidth > 0 && _this.realHeight > 0) {
                ...
                if (AmCharts.ifArray(chartData)) {
                    ...
                    if (categoryAxis.parseDates && !categoryAxis.equalSpacing) {
                        ...
                        if (isNaN(start)) {
                            if (!isNaN(_this.startTime)) {
                                start = _this.getClosestIndex(chartData, "time", _this.startTime, true, 0, chartData.length);
                            }
                        }

                        if (isNaN(end)) {
                            if (!isNaN(_this.endTime)) {
                                end = _this.getClosestIndex(chartData, "time", _this.endTime, false, 0, chartData.length);
                            }
                        }
