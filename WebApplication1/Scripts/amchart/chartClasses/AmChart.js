    ...
    AmCharts.AmChart = AmCharts.Class({
        ...
        measure: function() {
            ...
            if (div) {
                ...
                divRealWidth = div.offsetWidth;
                divRealHeight = div.offsetHeight;
*/
                if (div.clientHeight) {
                    divRealWidth = div.clientWidth;
                    divRealHeight = div.clientHeight;
        ...
        updateWidth: function() {
            ...
            if (legend) {
                ...
                if ((lPosition == "right" || lPosition == "left") && legend.divId === undefined) {
                    width -= legendWidth;
        ...
        handleDocTouchStart: function() {
            var _this = this;
            //   setTimeout(function() {
            //      _this.hideBalloonReal(); // removed in v 3.20.19 to prevent hiding balloon on touch devices
            //   }, 300); 
