                ...
                if (lText) {
                    if (chart.type != "radar") {
                        if (isRotated) {
                            ...
                            if (!_this.showAllValueLabels && lText) {
        ...
        */
            ...
            for (i = start; i <= end; i++) {
                ...
                if (values) {
                    ...
                    yClose = AmCharts.fitToBounds(yClose, -30000, 30000); // this is done to avoid slowness when min max is set and values are way out of bounds
                                ...
                                if (changeColor || (graphDataItem.lineColor != UNDEFINED && graphDataItem.lineColor != _this.lineColorSwitched) || (graphDataItem.fillColors != UNDEFINED && graphDataItem.fillColors != _this.fillColorsSwitched) || !isNaN(graphDataItem.dashLength)) {
                                    ...
                                    if (useNegativeColorIfDown) {
                                        if (nowIsPositive) {
                                            ...
                                            if (_this.bulletColor === undefined) {
                                                _this.bulletColorSwitched = lineColor;
                                            }
                                        } else {
                        ...
                        case "step":
                            if (!isNaN(close)) {
                                ...
                                if ((changeColor || graphDataItem.lineColor != UNDEFINED || graphDataItem.fillColors != UNDEFINED || !isNaN(graphDataItem.dashLength))) {
                                    ...
                                    if (stackableLine) {
                                        sxx = [lastX, lastX + stepLineDelta1 + stepLineDelta2];
                                        syy = [previousyOpen, previousyOpen];
                                    }
