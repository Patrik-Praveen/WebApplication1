(function() {
    ...
    AmCharts.SimpleChartScrollbar = AmCharts.Class({
        ...
        construct: function(theme) {
            ...
            _this.dragCursorHover = "cursor: move; cursor: grab; cursor: -moz-grab; cursor: -webkit-grab;";
            _this.dragCursorDown = "cursor: move; cursor: grab; cursor: -moz-grabbing; cursor: -webkit-grabbing;"

            //_this.vResizeCursorHover = "cursor: cursor: grab; cursor:-moz-grab; cursor:-webkit-grab;";
            //_this.hResizeCursorHover = "cursor: cursor: grab; cursor:-moz-grab; cursor:-webkit-grab;";
            //_this.vResizeCursorDown = "cursor: cursor: grab; cursor:-moz-grabbing; cursor:-webkit-grabbing;";
            //_this.hResizeCursorDown = "cursor: cursor: grab; cursor:-moz-grabbing; cursor:-webkit-grabbing;";

            _this.vResizeCursor = "ns-resize";
            _this.hResizeCursor = "ew-resize";
        ...
        draw: function() {
            ...
            if (_this.enabled) {
                ...
                if (rotate) {
                    AmCharts.setCN(chart, set, "scrollbar-vertical");
                } else {
                    AmCharts.setCN(chart, set, "scrollbar-horizontal");
                }
        ...
        leftDragStart: function() {
            ...
            _this.dragger.stop();
            _this.resizingLeft = true;
            _this.updateGripCursor(true);
        },

        updateGripCursor: function(down) {
            var _this = this;
            if (AmCharts.isModern) {
                var resizeCursor;
                if (_this.rotate) {
                    if (down) {
                        resizeCursor = _this.vResizeCursorDown;
                    } else {
                        resizeCursor = _this.vResizeCursorHover;
                    }
                } else {
                    if (down) {
                        resizeCursor = _this.hResizeCursorDown;
                    } else {
                        resizeCursor = _this.hResizeCursorHover;
                    }
                }
                if (resizeCursor) {
                    if (_this.iconRight) {
                        _this.iconRight.node.setAttribute("style", resizeCursor);
                    }
                    if (_this.iconLeft) {
                        _this.iconLeft.node.setAttribute("style", resizeCursor);
                    }
                }
            }
        },
        ...
        iconRollOver: function() {
            var _this = this;
            if (_this.rotate) {
                if (_this.vResizeCursor) {
                    _this.chart.setMouseCursor(_this.vResizeCursor);
                }
            } else {
                if (_this.hResizeCursor) {
                    _this.chart.setMouseCursor(_this.hResizeCursor);
                }
            }
