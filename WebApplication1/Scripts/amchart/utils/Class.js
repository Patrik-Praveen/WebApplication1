...
(function() {
    ...
    AmCharts.removeChart = function(chart) {
        ...
        if (charts.length === 0) {
            if(AmCharts.requestAnimation){
                window.cancelAnimationFrame(AmCharts.requestAnimation);       
                AmCharts.animationRequested = false;             
            }
    ...
    AmCharts.update = function() {
        ...
        if (window.requestAnimationFrame) {
            AmCharts.requestAnimation = window.requestAnimationFrame(AmCharts.update);
        }
    };
