(function() {
    ...
    AmCharts.AmXYChart = AmCharts.Class({
        ...
        drawChart: function() {
            ...
            if(_this.legend){
                _this.legend.valueText = undefined;
            }            
        ...
        validateData: function() {
            ...
            if (_this.zoomOutOnDataUpdate) {
                var valueAxes = _this.valueAxes;
                for (var i = 0; i < valueAxes.length; i++) {
                    valueAxes[i].minZoom = NaN;
                    valueAxes[i].maxZoom = NaN;
                }                
            }

            AmCharts.AmXYChart.base.validateData.call(_this);
        },       
